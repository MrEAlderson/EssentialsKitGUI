...
public class GeneralConfig {
    ...
    public static void loadAndUpdate(Plugin plugin) {
        ...
        inventoryTitlePage = ChatColorUtil.translate(root.getString("inventory-title-page", "Kits - Page {page}"));
        ...
        if (listenToCommands.isEmpty())
            listenToCommands.addAll(Arrays.asList("kit", "kits"));
    ...
    public static void save(Plugin plugin) {
        ...
        root.addComment("The amount of offset there shall be for the kit items");
        ...
        root.addComment("The commands with which the kit GUI shall open");
